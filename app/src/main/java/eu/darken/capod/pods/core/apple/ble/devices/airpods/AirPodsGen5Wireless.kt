...
data class AirPodsGen5Wireless(
    ...
    override val model: PodModel = PodModel.AIRPODS_GEN5_WIRELESS
    ...
    class Factory @Inject constructor(
        ...
        override suspend fun create(
            ...
            var basic = AirPodsGen5Wireless(scanResult = scanResult, payload = payload, meta = meta)
    ...
    companion object {
        private val DEVICE_CODE = 0x3020.toUShort()
        private val TAG = logTag("PodDevice", "Apple", "AirPods", "Gen5", "Wireless")
    }
}
